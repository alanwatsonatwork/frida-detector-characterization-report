...
Some H2RGs suffer from alternating-column noise or ACN \citep{rauscher-2022} and are better corrected by considering the odd and even columns in each channel separately. We have seen no evidence for ADC in the FRIDA H2RG, but our code has an option to perform this correction.
